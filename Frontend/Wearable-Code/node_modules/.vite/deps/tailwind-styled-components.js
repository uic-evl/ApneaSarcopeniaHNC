...
// node_modules/tailwind-styled-components/dist/tailwind-styled-components.esm.js
...
var C = (e) => (n, ...r) => {
  let o = (t = []) => {
    let i = import_react.default.forwardRef((a, u) => {
      ...
      return import_react.default.createElement(m, { ...f, style: { ...w, ...x }, ref: u, className: S(b(n, r.map((l) => l({ ...s, $as: p }))), s.className), ...c(e) ? { $as: p } : {} });
    });
...
//# sourceMappingURL=tailwind-styled-components.js.map
