...
from healthcare.views import get_patients, get_patient_ids, get_activity_summary, get_patient_details, \
    get_activity_zones, get_activity_metrics, get_calorie_count, get_body_weight_metrics, get_body_fat_metrics, \
    get_sleep_zones, get_heart_rate_zones
