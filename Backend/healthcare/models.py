...
class ActivitySummary(models.Model):
    fb_user = models.ForeignKey(Profile, on_delete=models.CASCADE, related_name='activity_summary')
...
class SleepSummary(models.Model):
    fb_user = models.ForeignKey(Profile, on_delete=models.CASCADE, related_name='sleep_summary')
    date = models.DateField(default=None)
    data = models.JSONField(default=dict)
...
class FoodSummary(models.Model):
    fb_user = models.ForeignKey(Profile, on_delete=models.CASCADE, related_name='food_summary')
    date = models.DateField(default=None)
    data = models.JSONField(default=dict)
...
class WaterSummary(models.Model):
    fb_user = models.ForeignKey(Profile, on_delete=models.CASCADE, related_name='water_summary')
    date = models.DateField(default=None)
    data = models.JSONField(default=dict)
...
class BodyFatLog(models.Model):
    fb_user = models.ForeignKey(Profile, on_delete=models.CASCADE, related_name='fat_logs')
    date = models.DateField(default=None)
    data = models.JSONField(default=dict)
...
class BodyWeightLog(models.Model):
    fb_user = models.ForeignKey(Profile, on_delete=models.CASCADE, related_name='weight_logs')
    date = models.DateField(default=None)
    data = models.JSONField(default=dict)
...
class HeartRateSummary(models.Model):
    fb_user = models.ForeignKey(Profile, on_delete=models.CASCADE, related_name='heart_rate_summary')
    date = models.DateField(default=None)
    data = models.JSONField(default=dict)
